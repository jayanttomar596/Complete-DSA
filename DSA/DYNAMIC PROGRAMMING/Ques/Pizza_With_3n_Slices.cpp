...
// | ----------------------- | --------------- | ---------------- |
// | Recursion (Brute Force) | `O(2^k)`        | `O(k)` (stack)   |
// | Memoization             | `O(k^2)`        | `O(k^2)`         |
// | Tabulation              | `O(k^2)`        | `O(k^2)`         |
// | Space Optimized (SO)    | `O(k^2)`        | `O(k)`           |
...
int main() {
    ...
    vector<int> slices = {1, 2, 3, 4, 5, 6};  // Example input
    ...
    cout << "Using Recursion: " << rec.maxSizeSlices(slices) << endl;
    cout << "Using Recursion + Memoization: " << memo.maxSizeSlices(slices) << endl;
    cout << "Using Tabulation: " << tab.maxSizeSlices(slices) << endl;
    cout << "Using Space Optimization: " << so.maxSizeSlices(slices) << endl;
